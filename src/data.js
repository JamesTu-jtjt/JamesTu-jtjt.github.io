...
export const news = [
  ['Aug 2026', 'Started my PhD at Cornell, happy to meet if you\'re in Ithaca!'],
  ['Jul 2026', 'OmniCode presented at ACL 2026.'],
  ['Jun 2026', 'I am concluding my time at Appier on June 30th.'],
  ...
  ['Nov 2025', 'Spoke at the NCKU Statistics Alumni Homecoming and launched an AI Agents research group at GDG NYCU.'],
  ['Oct 2025', 'Joined Appier as a full-time Software Engineer.'],
  ['Sep 2025', 'Returned to GDG NYCU as a project leader.'],
  ['Aug 2025', 'QAgent, an LLM-powered test-planning harness, received the Practical Impact Award (2nd place) at the Appier Hackathon.'],
  ['Jul 2025', 'Returned to Appier as a quality assurance intern.'],
  ['Jun 2025', 'CoverIQ released two projects and placed 3rd at the TCSE competition.'],
  ...
  ['Jan 2025', 'Our JISE paper on input relation prompting was published.'],
  ...
  ['May 2024', 'Our team earned 2nd place and the Popularity Award at the Taipei Metro Hackathon.'],
  ['Nov 2023', 'Completed the TCA International Talent Program at SEAMEO RECSAM; received the Global Supernova Award.'],
  ['Jun 2023', 'Our work received the Best Paper Award at TCSE 2023; grateful to my advisor.'],
  ['May 2023', 'Completed an RLAIF senior project on LLM fine-tuning for code generation with a 45% improvement across 145 coding tasks.'],
  ['Dec 2022', 'Grateful to our team for placing 2nd globally in the IEEE Big Data Cup and publishing our work at IEEE BigData.'],
  ['Oct 2022', 'Our team received the MediaTek Better Future Award at the NASA Space Apps Challenge.'],
  ['2020', 'Built a Class Info Collector CLI for NCKU’s Office of International Affairs.'],
]
...
export const munYears = [
  ...
  ['2018', ['NTCMUN — UNDP Delegate (Best Delegation)', 'FLYMUN — USG of Academics & SOCHUM Chair', 'TAMUN — USG of Academics & DISEC Chair', 'YaleMUN — ECOFIN Delegate (Honorable Mention)']],
  ['2017', ['TaoMUN — UNHRC Delegate (Best Delegate)', 'NTCMUN — FAO Delegate (Outstanding Delegation)']],
]
